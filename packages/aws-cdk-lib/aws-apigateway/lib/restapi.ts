...
export class SpecRestApi extends RestApiBase {
   ...
   */
  public static readonly UNIQUE_FQN: string = 'aws-cdk-lib.aws-apigateway.SpecRestApi';
  ...
  constructor(scope: Construct, id: string, props: SpecRestApiProps) {
    ...
    props = applyInjectors(SpecRestApi.UNIQUE_FQN, props, {
      scope,
      id,
    });
...
export class RestApi extends RestApiBase {
   ...
   * Uniquely identifies this class.
   */
  public static readonly UNIQUE_FQN: string = 'aws-cdk-lib.aws-apigateway.RestApi';
  ...
  constructor(scope: Construct, id: string, props: RestApiProps = { }) {
    // Blueprint Property Injection
    props = applyInjectors(RestApi.UNIQUE_FQN, props, {
      scope,
      id,
    });
